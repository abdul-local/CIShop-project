...
<div class="row">
    <div class="col-md-9">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <span class="float-right">
                          Urutan Harga: <a href="#" class="badge badge-primary">Termurah</a> | <a href="#" class="badge badge-danger">Termahal</a>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="col mb-3">
                    <img src="<?= $row->image ? base_url("images/product/$row->image") :''?>" alt="" class="card-img-top" height="">
                    <div class="card-body">
