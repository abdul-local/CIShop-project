					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<span class="float-right">
								Urutkan Harga: <a href="<?= base_url("index.php/shop/orderby/asc") ?>" class="badge badge-primary">Termurah</a> | <a href="<?= base_url("index.php/shop/orderby/desc") ?>" class="badge badge-primary">Termahal</a>
							</span>
						</div>
					</div>
				</div>
